  ...
  module Client
    module HTTP
      describe Headers do
        ...
        it 'provides case-insensitive access to keys' do
        ...
        describe '#each' do
          ...
          it 'yields headers keys and values' do
            headers['key1'] = 'value1'
            headers['key2'] = 'value2'
            yielded = headers.map do |key, value|
              [key, value]
            end
            expect(yielded.sort_by(&:first))
              .to eq([
                       %w[key1 value1],
                       %w[key2 value2]
                     ])
        ...
        describe '#keys' do
          it 'returns the keys' do
            headers['key1'] = 'value1'
            headers['key2'] = 'value2'
            expect(headers.keys).to eql(%w[key1 key2])
          end
        end
        ...
        describe '#values' do
          it 'returns the values' do
            headers['key1'] = 'value1'
            headers['key2'] = 'value2'
            expect(headers.values).to eql(%w[value1 value2])
          end
        end
        ...
        describe '#values_at' do
          it 'returns the values for the given keys' do
            headers['key1'] = 'v1'
            headers['key2'] = 'v2'
            expect(headers.values_at('key2', 'key1')).to eql(%w[v2 v1])
          end
        end
